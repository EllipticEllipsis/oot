...
void EnJj_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    switch (this->dyna.actor.params) {
        case -1:
            ...
            this->unk_300 = (DynaPolyActor*)Actor_SpawnAsChild(
            ...
            DynaPolyInfo_Alloc(&D_06000A1C, &colHeader);
        ...
        case 0:
            DynaPolyInfo_SetActorMove(&this->dyna, 0);
            DynaPolyInfo_Alloc(&D_06001830, &colHeader);
            this->dyna.dynaPolyId =
                DynaPolyInfo_RegisterActor(globalCtx, &globalCtx->colCtx.dyna, &this->dyna.actor, colHeader);
        ...
        case 1:
            DynaPolyInfo_SetActorMove(&this->dyna, 0);
            DynaPolyInfo_Alloc(&D_0600BA8C, &colHeader);
            this->dyna.dynaPolyId =
                DynaPolyInfo_RegisterActor(globalCtx, &globalCtx->colCtx.dyna, &this->dyna.actor, colHeader);
            this->dyna.actor.update = func_80A87F44;
            this->dyna.actor.draw = NULL;
...
void func_80A87B9C(EnJj* this, GlobalContext* globalCtx) {
    DynaPolyActor* otherJabu = this->unk_300;

    if (this->unk_308 >= -0x1450) {
        this->unk_308 = (s16)(this->unk_308 - 0x66);
        if (this->unk_308 < -0xA28) {
            func_8003EBF8(globalCtx, &globalCtx->colCtx.dyna, otherJabu->dynaPolyId);
        }
    }
}
...
void EnJj_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if ((globalCtx->csCtx.state != 0) && (globalCtx->csCtx.npcActions[2] != 0)) {
    ...
    Actor_SetScale(&this->dyna.actor, 0.087f);
    this->skelanime.limbDrawTbl[10].z = (s16)this->unk_308;
}
